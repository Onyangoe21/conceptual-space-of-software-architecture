...
\begin{abstract}
\noindent With recent advances in LLMs, whether or not software engineering can be replaced fully
by machines is a big question. With code generation proving a simple task given a description of
what to generate, the focus is shifting higher in the stack to things like architecture. Every
coding agent today navigates a codebase through its observables: the file tree, a symbol graph, text
